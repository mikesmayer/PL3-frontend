...
(function ($) {
    ...
    SEMICOLON.header = {
        ...
        splitmenu: function () {
            ...
            if (($body.hasClass('device-lg') || $body.hasClass('device-md')) && $header.hasClass('split-menu')) {
                ...
                $('#primary-menu').find('.menu-left').css({
                    'padding-right': menuPadding + 'px'
                });
                $('#primary-menu').find('.menu-right').css({
    ...
    SEMICOLON.slider = {
        ...
        //                 'transform': 'translateY(' + (($window.scrollTop() - parallaxOffsetTop) / 1.5) + 'px)'
        //             });
        //             $('.slider-parallax .slider-caption,.ei-title').css({
        //                 'transform': 'translateY(-' + (($window.scrollTop() - parallaxOffsetTop) / 7) + 'px)'
        //             });
        //         } else {
